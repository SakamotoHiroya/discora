...
@function_tool
async def instract_notion_agent(context: RunContextWrapper[DiscordContext], message: str) -> str:
    """
...
@function_tool
async def instract_discord_agent(context: RunContextWrapper[DiscordContext], message: str) -> str:
    """
